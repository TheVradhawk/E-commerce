...
const Header = () => {
    ...
    return <header className={`w-full h-[50px] md:h-[80px] bg-white flex items-center justify-between z-20 sticky top-0 transition-transform duration-300 ${show}`}>
       ...
       <Wrapper className="h-[60px] flex justify-between item-center">
        <Link href="/">
            <img src='/hypesd (3).png' className="w-[120px] md:w-60px" />
        </Link>
        ...
        <div className="h-[14px] md:h-[18px] min-w-[14px] md:min-w-[18px] rounded-full bg-red-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[12px] flex justify-center px-[2px] md:px-[5px]">11</div>
